...
#define MOTOR_CONTROL1              GPIO_NUM_6
#define MOTOR_CONTROL2             GPIO_NUM_7
#define AUDIO_I2S_GPIO_MCLK         GPIO_NUM_12
#define AUDIO_I2S_GPIO_BCLK         GPIO_NUM_13
#define AUDIO_I2S_GPIO_WS           GPIO_NUM_14
#define AUDIO_I2S_GPIO_DIN          GPIO_NUM_15  //GPIO_NUM_15
#define AUDIO_I2S_GPIO_DOUT         GPIO_NUM_16  //GPIO_NUM_16
...
#define DISPLAY_SPI_SCLK_HZ         (20 * 1000 * 1000) //80
...
#define DISPLAY2_MIRROR_X       false  //true
#define DISPLAY2_MIRROR_Y       false  //true
